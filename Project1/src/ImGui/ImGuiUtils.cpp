...
bool DrawTransformVector4ImGui(std::string label, glm::vec4& values, float resetValue, float& columnWidth)
{
	...
	ImGui::SameLine();
	if (ImGui::DragFloat("##W", &values.w, 0.1f, 0, 0, "%0.2f")) { initiated = true; }
	ImGui::PopItemWidth();
